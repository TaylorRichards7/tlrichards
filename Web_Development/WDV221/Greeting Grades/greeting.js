...
function greeting() {
	...
	if (currentTime >= 6 && currentTime < 12) {
		header.innerHTML = "Good Morning Student!";
		header.style.color = "black";						// 4. Set a color for the greeting
	}
	else {
		if (currentTime >= 12 && currentTime < 17) {
			header.innerHTML = "Good Afternoon Student!";
			header.style.color = "black";					// 5. Set a color for the greeting	
		}
		else {
			header.innerHTML = "Good Evening Student!";
